...
Once your earthpy-dev environment is activated, install Matplotcheck in editable
...
vignette in the ``examples`` folder within the ``earthpy`` directory. Matplotcheck

...
def test_ax_not_provided(rgb_image):
    """Test to ensure that plot_rgb produces a output image on an axis
    when an axis object is not provided."""
...
def test_stretch_image(rgb_image):
    """Test to ensure that running stretch actually stretches the data

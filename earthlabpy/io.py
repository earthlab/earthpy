...
DATA_URLS = {
    ...
    # Just for testing - I have no idea what this file is but it's the 1st that popped up on google lol
    'test': [('https://www.colorado.edu/conflict/peace/download/peace_essay.ZIP', 'testfile', 'file'),
             ('https://www.colorado.edu/conflict/peace/download/peace_essay.ZIP', 'testfile_folder', 'zip'),
             ('https://www.colorado.edu/conflict/peace/download/peace_essay.ZIP', '.', 'zip')],
}
